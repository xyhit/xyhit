...
/*$menuList = array(
				...
				array('id'=>'11', 'pid'=>'1', 'name'=>'注册', 'type'=>'view', 'code'=>'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.WECHAT_APPID.'&redirect_uri='.urlencode(WECHAT_URL."/user_module/oauth2.php").'&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect'),
				...
				array('id'=>'21', 'pid'=>'2', 'name'=>'捐款排行', 'type'=>'view', 'code'=>'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.WECHAT_APPID.'&redirect_uri='.urlencode(WECHAT_URL."/fund_module/fund.php").'&response_type=code&scope=snsapi_base&state=126#wechat_redirect'),
